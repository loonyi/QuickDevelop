...
namespace QuickDevelop.Tests.Sessions
{
    public abstract class QuickDevelopTestBase : AbpIntegratedTestBase
    {
        protected QuickDevelopTestBase()
        {
        ...
        protected override void AddModules(ITypeList<AbpModule> modules)
        {
            ...
            modules.Add<QuickDevelopApplicationModule>();
            modules.Add<QuickDevelopDataModule>();
        }

        public void UsingDbContext(Action<QuickDevelopDbContext> action)
        {
            using (var context = LocalIocManager.Resolve<QuickDevelopDbContext>())
            {
        ...
        public T UsingDbContext<T>(Func<QuickDevelopDbContext, T> func)
        {
            T result;
